            ...
            public boolean onLongClick(View view) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if(R.id.calendar == item.getItemId()) {
                            Intent intent = new Intent(Intent.ACTION_EDIT);
                            intent.setType("vnd.android.cursor.item/event");
                            intent.putExtra(CalendarContract.Events.TITLE, event.getTitle());
                            intent.putExtra(CalendarContract.EXTRA_EVENT_BEGIN_TIME, event.askDateAsCalendar().getTimeInMillis());
                            intent.putExtra(CalendarContract.EXTRA_EVENT_END_TIME, event.askDateAsCalendar().getTimeInMillis() + 3600000);
                            intent.putExtra(CalendarContract.Events.ALL_DAY, false);
                            intent.putExtra(CalendarContract.Events.DESCRIPTION, "Event generated by NotLateApp");
                            intent.putExtra(CalendarContract.Events.ALLOWED_REMINDERS, CalendarContract.Reminders.METHOD_DEFAULT);
